 ...
 */
package org.jrebirth.af.presentation.eclipsecon.ui.slides.handler;
 ...
 */
public final class HandlerController extends AbstractBaseController<HandlerModel, HandlerView> {
    ...
    protected void initEventHandlers() throws CoreException {
        ...
        view().getScene().addEventFilter(MouseEvent.MOUSE_CLICKED, filter);
        ...
        view().getScene().addEventHandler(MouseEvent.MOUSE_CLICKED, handler);
